...
This plugin creates a function called thumbGen() that allows to show any image in the specified size. It saves all generated thumbs in a cache directory under "uploads" folder.
